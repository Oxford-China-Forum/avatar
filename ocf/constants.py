...
TICKET_TEXT = [
    {'text': '4044 年，\n来到未来的你，入学成为了牛津大学建立于', 'color': 'black'},
    {'text': ' {year} ', 'color': '#bf252d'},
    {'text': '年的', 'color': 'black'},
    {'text': '{chinese} {english} ', 'color': '#bf252d'},
    {'text': '的一名', 'color': 'black'},
    {'text': '{occupation}', 'color': '#bf252d'},
    {'text': '，正在潜心研究', 'color': 'black'},
    {'text': '{major}', 'color': '#bf252d'},
    {'text': '专业。', 'color': 'black'},
    {'text': '有一天你沿着小路，慢慢来到了熟悉的', 'color': 'black'},
    {'text': '{location}', 'color': '#bf252d'},
    {'text': '准备好好享受一下美丽的春色。\n\n突然，你听见有一段录像带在吱扭吱扭播放，传来了来自古老远方地球蓝星上的智者声音，在讲着古早人类时期“', 'color': 'black'},
    {'text': '{topic}', 'color': '#bf252d'},
    {'text': '”。你不由听得入了神。\n\n', 'color': 'black'},
    {'text': '8088年，\n录像带里的声音一直回荡在你心里，通过不懈的努力，你成功成为了这个时代次元该领域的头号人物。', 'color': 'black'},
]
