...
TICKET_LOCATIONS = ['考试院', '圣母玛利亚大学教堂', '拉德克利夫天文角', '谢尔登剧院', '大學公園', '植物园', '米爾城堡', '科学区', '高街', '阿什莫林艺术与考古博物馆', '皮特河博物馆', '叹息桥']
...
TICKET_TEXT = '''
4044 年，来到未来的你，
入学成为了牛津大学建立于 {year} 年的{chinese} {english} 的一名{occupation}，正在潜心研究{major}专业。
有一天你沿着小路，慢慢来到了熟悉的{location}准备好好享受一下美丽的春色。
突然听见有一段录像带在吱扭吱扭播放，传来了来自古老远方地球蓝星上的智者声音，
在讲古早人类时期{topic}。
你不由听得入了神。
